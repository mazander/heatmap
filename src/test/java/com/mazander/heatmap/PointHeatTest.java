...
public class PointHeatTest {
	...
	public void testGetHeatAt() {
		...
		assertEquals(100.0, new PointHeat(0.0, 0.0, 100.0, 10.0).withAttenuation(Attenuations.NO).getHeatAt(0.0, 5.0), 0.0);
		...
		assertEquals(12.5, new PointHeat(0.0, 0.0, 100.0, 10.0).withAttenuation(Attenuations.CUBIC).getHeatAt(0.0, 5.0), 0.0);
